  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.boldText}>SHARING -</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.boldText}>SECURITY PRECAUTIONS -</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.boldText}>DATA DELETION AND RETENTION -</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          Name of the Office: ODHPay{"\n"}
          Designation: Lucknow{"\n"}Name and Address of the Company: ODHPay
          {"\n"}Contact us: odhpay@gmail.com{"\n"}
          Phone: Time: Monday - Friday(9:00 - 18:00)
        </Text>

        <Text style={styles.boldText}>Refund and Cancellation policy -</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          1. Cancellations will only be considered if the request is made 1 days
        ...
        <Text style={styles.paragraph}>
          3. In case of receipt of damaged or defective items, please report to
